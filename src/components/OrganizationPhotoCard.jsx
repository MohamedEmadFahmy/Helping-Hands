...
const PopularCauseCard = ({ imageLink, title, description }) => {
	return (
		<div className="bg-primary w-full h-full shadow-md border rounded-lg flex flex-col items-center justify-end p-2 hover:scale-105 cursor-pointer relative">
			<div
				className="h-2/3 w-full bg-cover bg-no-repeat rounded-lg "
				style={{
