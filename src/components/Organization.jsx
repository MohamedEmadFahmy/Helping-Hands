...
import G57357 from "../assets/organisation-images/57357.jpeg";
import G157357 from "../assets/organisation-images/G157357.jpeg";
import rman1 from "../assets/organisation-images/rman1.jpg";
import rman from "../assets/organisation-images/rman.jpeg";
import ahl1 from "../assets/organisation-images/ahl1.jpeg";
import ahl from "../assets/organisation-images/ahl.jpeg";
	...
	return (
		<div className="flex flex-col min-h-screen px-4 py-6 bg-blue-100">
			<div className="flex flex-col justify-center items-center mb-6">
				<h1 className="text-xl font-bold text-center mr-4 bg-white">
					{" "}
					Admin Account Managment
				</h1>
				<div className="mt-4"></div>{" "}
				{/* This adds a margin-top of 1rem (16px) */}
				<h3 className="text-xl font-bold text-center mr-4">
					Organisations
				</h3>
				<div className="mt-4"></div>{" "}
				{/* This adds a margin-top of 1rem (16px) */}
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div className="flex flex-col bg-white rounded-md shadow-md p-4">
					...
					<p className="text-gray-600 mb-1">
						Type: Research Cancer Hospital
					</p>
					<p className="text-gray-600 mb-1">Area: Cairo</p>
					<img
						src={G57357}
						alt="Hospital Picture"
						className="w-full h-40 rounded-b-md"
					/>
				</div>
