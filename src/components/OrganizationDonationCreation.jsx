...
const OrganizationDonationCreation = () => {
	...
	return (
		<div className="bg-gradient-to-trfrom-secondaryshades-800 to-secondaryshades-900flex flex-col items-center justify-center pt-8 pb-8 gap-5 w-screen h-full">
