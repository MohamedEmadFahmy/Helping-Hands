...
const OrganizationDonationCreation = () => {
	...
	return (
		<div className="bg-gradient-to-tr border border-black from-secondaryshades-800 to-secondaryshades-900 rounded-lg flex flex-col items-center justify-center pt-8 pb-8 gap-5 w-screen h-full">
			...
			>
				...
				<div className="relative w-1/3">
					...
					<div
						className={`absolute top-0 right-0 bg-gray-300 rounded-full w-8 h-8 flex justify-center items-center transition-transform ${
...
export default OrganizationDonationCreation;
