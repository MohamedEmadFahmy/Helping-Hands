...
const VolunterCard = ({
	...
	return (
		<>
			<div className="flex flex-col bg-white rounded-md shadow-md p-4 relative w-5/12">
				<div
					alt=""
					...
					<div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-grey-800 bg-opacity-50 z-[70]">
						<div className="bg-white rounded-3xl shadow-2xl p-6 w-1/3 h-3/12">
							...
							<div className="flex justify-between mt-4">
								<button className="px-4 py-2 bg-blue-500 text-white rounded-md mr-2 hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-blue-800">
