...
const OrganizationAccount = () => {
    ...
    const [googleMapsLink, setGoogleMapsLink] = useState("https://maps.google.com/example");
    ...
    const [isGoogleMapsLinkEditing, setIsGoogleMapsLinkEditing] = useState(false);
        ...
        return (
            <div className="bg-gray-200 p-4 rounded-lg shadow-md mt-12 w-1/2">
                ...
                <div className="border-b border-gray-400 mb-4 pb-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                            <p className="text-gray-600 mr-2">Organization Name:</p>
                            {isOrgNameEditing ? (
                                <input
                                    type="text"
                                    value={orgName}
                                ...
                                <p className="text-gray-800 font-semibold">{orgName}</p>
                            )}
                        </div>
                        <button
                ...
                <div className="border-b border-gray-400 mb-4 pb-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                            <p className="text-gray-600 mr-2">Google Maps Link:</p>
                            {isGoogleMapsLinkEditing ? (
                                ...
                                <p className="text-gray-800 font-semibold">{googleMapsLink}</p>
                            )}
                        </div>
                        <button
                ...
                <div className="pb-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                            <p className="text-gray-600 mr-2">Organization Type:</p>
                            {isOrgTypeEditing ? (
                                <select
                                    value={orgType}
                                ...
                                <p className="text-gray-800 font-semibold">{orgType}</p>
                            )}
                        </div>
                        <button
